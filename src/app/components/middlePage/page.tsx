      ...
      <div className="py-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <div className="space-y-12">
              ...
              <div className="md:w-1/2 text-left">
                ...
                <div className="text-gray-700">
                  ...
                  <ul>
                    ...
                    <li><strong>5 Protein Options</strong>  Stock chicken  tofu  or canned beans for easy sources of protein These can be used in stir fries  tacos  salads  or served as a main dis </li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-x-8 md:space-y-0">
              <div className="md:w-1/2 text-left">
                <h4 className="text-2xl font-semibold text-gray-900 mb-4">Step  Pick a Recipe</h4>
                <div className="text-gray-700">
                  <p>Now that you have your ingredients ready it&apos;s time to pick a recipe that suits your current craving and dietary needs Whether you are in the mood for something quick and comforting or light and fresh here are a few ideas to get you started</p>
                  <ul>
                    ...
                    <li><strong>3 StirFry</strong>  A great way to use up vegetables and protein like chicken or tofu Stirfries are quick customizable and full of flavor Serve it with rice or noodles for a filling meal</li>
...
width={800}
              ...
              <div className="md:w-1/2 text-left">
                ...
                <ul>
                  <li><strong>1 Slice  Chop</strong>  Prepare all your vegetables herb and proteins by slicing dicing or chopping them as needed Having everything prepped will help you avoid scrambling during the cooking process</li>
                  ...
                  <li><strong>3 Preheat the Oven or Pan</strong>  Whether you&apos;re baking sautrins or grilling preheating your cooking surface ensures even cooking and saves time in the long run Set your oven to the desired temperature or heat up your pan while you prep the ingredients</li>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-x-8 md:space-y-0">
              <div className="md:w-1/2 text-left">
                ...
                <ul>
                  <li><strong>1 Set the Table</strong>  Make your dining experience special by setting the table Whether you&apos;re dining alone or with friends a wellset table can make your meal feel more enjoyable</li>
                  ...
                  <li><strong>3 Dig In</strong>  Now the best parteat Enjoy every bite of your meal knowing that you&apos;ve created something delicious and nourishing from scratch.</li>
